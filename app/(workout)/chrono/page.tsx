        ...
        <CardContent className="p-8">
          <div className="text-center space-y-6">
            ...
            <div className="relative">
              ...
              <div className="text-6xl font-mono font-bold tracking-tight tabular-nums">{formatTime(time)}</div>
            </div>

            {/* Contrôles */}
            <div className="flex justify-center gap-3">
              {!isRunning ? (
                <Button onClick={handleStart} size="lg" className="w-20 h-20 rounded-full">
                  <Play className="h-6 w-6" />
                </Button>
              ) : (
                <Button onClick={handlePause} size="lg" variant="secondary" className="w-20 h-20 rounded-full">
                  <Pause className="h-6 w-6" />
                </Button>
              )}

              <Button onClick={handleReset} size="lg" variant="outline" className="w-20 h-20 rounded-full">
