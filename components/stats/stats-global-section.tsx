...
import { Calendar, ChartScatter, PieChart, TrendingUp } from 'lucide-react';
      ...
      <section className="space-y-4">
        ...
        <Card className="bg-gradient-to-br from-card to-card/50 border-border/50">
          <CardHeader className="pb-2">
            ...
            <CardDescription>Top 10 catégories les plus travaillées selon vos séries</CardDescription>
          </CardHeader>
          <CardContent>
